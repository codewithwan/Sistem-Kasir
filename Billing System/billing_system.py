...
class Bill_App:
    ...
    # =============customer retail details======================
        ...
        clock_frame = Frame(F1)
        clock_frame.grid(row=0, column=4, padx=600, pady=2)  # Atur posisi grid di dalam LabelFrame

        clock = DigitalClock(clock_frame, 0, 0, "#87CEEB", "black", 0)  # Objek DigitalClock harus diberi container yang tepat
    ...
    def play_sound(self):
        ...
        pygame.mixer.music.load(OUTPUT_PATH / Path(r'sound\bip.mp3'))  # Ganti dengan path file sesuai tempat (wajin)
    ...
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\tJaya Abadi\n", 'title')
